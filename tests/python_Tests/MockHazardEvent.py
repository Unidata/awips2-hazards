 ...
 *  Specialized for testing in Jim's Python Test Framework.
 * 
 * <pre>
 * 
 * SOFTWARE HISTORY
 ...
 * ------------ ---------- ----------- --------------------------
 * Dec 13, 2013            blawrenc    Initial creation. Based
 *                                     on thansens test event
 *                                     for VTEC tests
...
class HazardEvent:
    ...
    def setStartTime(self, startTime):
        self.startTime = str(startTime) # new Date(startTime.getTime())
    ...
    def setEndTime(self, endTime):
        self.endTime = str(endTime) # new Date(endTime.getTime())
    ...
    def setCreationTime(self, creationTime):
        self.creationTime = str(creationTime)  # new Date(creationTime.getTime())
