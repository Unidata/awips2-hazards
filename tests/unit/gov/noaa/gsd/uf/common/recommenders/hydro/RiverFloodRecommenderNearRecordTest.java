...
/**
 * Description: Tests the recommended hazard for a hydrograph which crests near
 * record levels. Checks to make sure that the hazard has the appropriate "NR"
 * flag set.
 * 
 * <pre>
 * 
 ...
 * @version 1.0
 */
public class RiverFloodRecommenderNearRecordTest {
    ...
    public void setUp() throws Exception {
        ...
        Object[][] forecasts = {
                ...
                { "BRON1", "HG", 0, "FF", "Z", -1, "2012-12-10 12:00:00",
                        "2012-12-07 15:17:00", 43.56, "Z", 1879048191, 1,
                        "KKRFRVFMOM", "2012-12-07 15:27:00",
                        "2012-12-07 22:05:23" },
    ...
    public void testRiverFloodRecommender() {
        ...
        assertEquals(43.56, attributeMap.get("crestStage"));
        assertEquals(21.95, attributeMap.get("currentStage"));
        assertEquals(1354941556951L, attributeMap.get("riseAbove"));
        assertEquals(1355160775680L, attributeMap.get("fallBelow"));
        assertEquals("NR", attributeMap.get("floodRecord"));
        assertEquals("3", attributeMap.get("floodSeverity"));
