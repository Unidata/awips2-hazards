 ...
 * {@link HazardAlertJobForTesting}s
 * 
 * <pre>
 * 
 * SOFTWARE HISTORY
 ...
 * @version 1.0
 */
public class HazardAlertJobFactoryForTesting implements IHazardAlertJobFactory {

    @Override
    public IHazardAlertJob createJob(HazardSessionAlertsManager alertsManager,
            IHazardAlert hazardAlert) {
        return new HazardAlertJobForTesting(alertsManager, hazardAlert);
    }
