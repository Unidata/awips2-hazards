...
/**
 * Modification of the expiration time of an event.
 * 
 * <pre>
 *
 * SOFTWARE HISTORY
 ...
 * ------------ ---------- ------------ --------------------------
 * Mar 23, 2018   11684    Chris.Golden Initial creation.
 * </pre>
 *
 * @author Chris.Golden
 */
public class EventExpirationTimeModification implements IEventModification {

    @Override
    public void apply(IHazardEventView sourceEvent, IHazardEvent targetEvent) {
        targetEvent.setExpirationTime(sourceEvent.getExpirationTime());
    }
