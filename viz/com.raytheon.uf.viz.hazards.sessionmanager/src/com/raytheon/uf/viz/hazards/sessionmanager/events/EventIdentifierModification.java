...
/**
 * Modification of the identifier of an event.
 * 
 * <pre>
 *
 * SOFTWARE HISTORY
 ...
 * @author Chris.Golden
 */
public class EventIdentifierModification implements IEventModification {

    @Override
    public void apply(IHazardEvent sourceEvent, IHazardEvent targetEvent) {
        targetEvent.setEventID(sourceEvent.getEventID());
    }
