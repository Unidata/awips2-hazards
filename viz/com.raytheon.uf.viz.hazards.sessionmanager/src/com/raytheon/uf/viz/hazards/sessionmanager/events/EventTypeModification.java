 ...
 * @author Chris.Golden
 */
public class EventTypeModification implements IEventModification {

    @Override
    public void apply(IHazardEventView sourceEvent, IHazardEvent targetEvent) {
        targetEvent.setHazardType(sourceEvent.getPhenomenon(),
                sourceEvent.getSignificance(), sourceEvent.getSubType());
    }
