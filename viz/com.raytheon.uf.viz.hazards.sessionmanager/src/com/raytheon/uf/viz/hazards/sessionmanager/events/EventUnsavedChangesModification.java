...
/**
 * Modification of the unsaved-changes flag of an event.
 * 
 * <pre>
 *
 * SOFTWARE HISTORY
 ...
 * @author Chris.Golden
 */
public class EventUnsavedChangesModification implements IEventModification {

    @Override
    public void apply(IHazardEvent sourceEvent, IHazardEvent targetEvent) {
        targetEvent.setModified(sourceEvent.isModified());
    }
