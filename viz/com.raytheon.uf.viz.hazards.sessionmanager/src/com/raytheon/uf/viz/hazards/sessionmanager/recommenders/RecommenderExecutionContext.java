...
public class RecommenderExecutionContext {
    ...
    /**
     * Set of identifiers of the hazard event attributes or decoration
     * attributes that changed, or <code>null</code> if the execution was not
     ...
     * @param attributeIdentifiers
     *            Set of identifiers of the decoration attributes that changed.
     * @return Context.
     */
     ...
     *            {@link Trigger #HAZARD_EVENT_DECORATION_CHANGE}.
     * @param attributeIdentifiers
     *            Set of identifiers of the hazard event attributes or
     *            decoration attributes that changed, or <code>null</code> if
     *            the execution was not triggered by a
     *            {@link Trigger#HAZARD_EVENT_MODIFICATION} or
     *            {@link Trigger #HAZARD_EVENT_DECORATION_CHANGE}.
     * @param eventType
     *            Suggested event type to be generated by the recommender, or
    ...
    /**
     * Get the set of identifiers of the hazard event attributes or decoration
     * attributes that changed, or <code>null</code> if {@link #getTrigger()}
