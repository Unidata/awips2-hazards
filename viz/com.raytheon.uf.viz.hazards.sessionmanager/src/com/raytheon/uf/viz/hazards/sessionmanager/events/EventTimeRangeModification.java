...
/**
 * Modification of the time range of an event.
 * 
 * <pre>
 *
 * SOFTWARE HISTORY
 ...
 * @author Chris.Golden
 */
public class EventTimeRangeModification implements IEventModification {

    @Override
    public void apply(IHazardEvent sourceEvent, IHazardEvent targetEvent) {
        targetEvent.setTimeRange(sourceEvent.getStartTime(),
