 ...
 * notify all components that the unsaved changes flag for a a particular hazard
 * event has changed.
 * 
 * <pre>
 * 
 ...
 * @version 1.0
 */
public class SessionEventUnsavedChangesModified extends SessionEventModified
        implements ISessionNotification {

    public SessionEventUnsavedChangesModified(
