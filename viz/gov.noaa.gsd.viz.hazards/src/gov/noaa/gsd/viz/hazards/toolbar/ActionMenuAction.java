 ...
 * {@link ActionMenuActionHelper} of the type specified by the generic parameter
 * <code>H</code>; when one of the actions is chosen from its drop-down menu,
 * that action is assigned as the principal of the associated instance of said
 * class, as well as being run. The generic parameter <code>A</code> is the
 * subclass's type.
 * 
 * <pre>
 * 
 ...
 * @author Chris.Golden
 */
public abstract class ActionMenuAction<A extends ActionMenuAction<A, H, P>, H extends ActionMenuActionHelper<A, H, P>, P extends BasicAction>
    ...
    /**
     * Helper paired with this chooser action. When an action is chosen from
     * this chooser's menu, it becomes the principal of this helper.
     */
    private final ActionMenuActionHelper<A, H, P> helperAction;
     ...
     */
    public ActionMenuAction(List<? extends P> actionChoices,
            Set<Integer> allowableStyles,
            ActionMenuActionHelper<A, H, P> helperAction) {
    ...
    /**
     * Set the selected action choice to that specified.
     * 
     * @param currentChoice
     *            New choice; must be one of the choices provided at creation
     *            time.
     */
    public void setSelected(P currentChoice) {
        helperAction.setPrincipal(currentChoice);
    }
