 ...
 **/
package com.raytheon.uf.viz.productgen.validation.util;
 ...
 * May 08, 2017 21461      Kevin.Bisanz Active table mode accounts for CAVE test mode.
 * </pre>
 * 
 * @author bwoodle
 * @version 1.0
...
public class VtecUtil {
    ...
    public static final Pattern VTEC_REGEX = Pattern.compile(
    ...
    public static GetNextEtnResponse getNextEtn(String office, String phensig,
        ...
        ActiveTableMode mode = (CAVEMode.PRACTICE.equals(CAVEMode.getMode()))
     ...
     */
    public static String replaceFirstVtecString(String message,
            VtecObject vtec) {
