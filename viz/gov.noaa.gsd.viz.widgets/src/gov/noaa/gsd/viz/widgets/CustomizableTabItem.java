...
/**
 * Description: Customizable tab item, to be used with a
 * {@link CustomizableTabFolder}.
 * <p>
 * Note that this class is a copy of {@link CTabItem}, with the addition of the
 * ability to set the tab text (foreground) color, and of course changed to work
 * with a <code>CustomizableTabFolder</code> instead of a {@link CTabFolder}.
 * The additions include the {@link #setForeground(Color)},
 * {@link #getForeground()}, {@link #setSelectionForeground(Color)}, and
 * {@link #getSelectionForeground()} methods, and the {@link #foreground} and
 * {@link #selectionForeground} member variables.
 * </p>
 * 
 * <pre>
 * 
 ...
 * @version 1.0
 */
public class CustomizableTabItem extends Item {
    CustomizableTabFolder parent;
     ...
     * <code>CustomizableTabFolder</code>) and a style value describing its
     * behavior and appearance. The item is added to the end of the items
     ...
     * 
     * @param parent
     *            a CustomizableTabFolder which will be the parent of the new
     ...
     * @see Widget#getStyle()
     */
    public CustomizableTabItem(CustomizableTabFolder parent, int style) {
        this(parent, style, parent.getItemCount());
    }

    /**
     * Constructs a new instance of this class given its parent (which must be a
     * <code>CustomizableTabFolder</code>), a style value describing its
     ...
     * <code>CustomizableTabFolder</code>.
     * 
     ...
     *                </ul>
     */
    public CustomizableTabFolder getParent() {
        // checkWidget();
        return parent;
    }
    ...
    /**
     * Get the foreground color used to paint the text.
     * 
     * @return Foreground color used to paint the text.
     */
    ...
    /**
     * Set the foreground color used to paint the text.
     * 
     * @param foreground
     *            New foreground color used to paint the text.
     */
    public void setForeground(Color foreground) {
        if (((this.foreground == null) && (foreground != null))
                || ((this.foreground != null) && (this.foreground
                        .equals(foreground) == false))) {
    ...
    /**
     * Get the foreground color used to paint the text when selected.
     * 
     * @return Foreground color used to paint the text when selected.
     */
    ...
    /**
     * Set the foreground color used to paint the text when selected.
     * 
     * @param foreground
     *            New foreground color used to paint the text when selected.
     */
    public void setSelectionForeground(Color foreground) {
        if (((this.selectionForeground == null) && (foreground != null))
                || ((this.selectionForeground != null) && (this.selectionForeground
                        .equals(foreground) == false))) {
     ...
     * area of the CustomizableTabFolder. Returns false otherwise.
     * 
    ...
    public void setControl(Control control) {
        ...
        if (this.control != null) {
            ...
            if (index == parent.getSelectionIndex()) {
                ...
                if (selectedIndex != -1) {
                    selectedControl = parent.getItem(selectedIndex)
                            .getControl();
                }
                ...
                if (bounds.width == oldBounds.width
                    ...
                    if (showing) {
                        ...
                        if (selected || parent.showUnselectedImage) {
                            CustomizableTabFolderRenderer renderer = parent.renderer;
                            Rectangle trim = renderer.computeTrim(index,
                                    SWT.NONE, 0, 0, 0, 0);
                                ...
                                if (parent.single
                                    ...
                                    imageX += renderer
                                            .computeSize(
                                                    ...
                                                    SWT.NONE, gc, SWT.DEFAULT,
                                                    SWT.DEFAULT).x;
                                }
                                int rightEdge = Math.min(x + width,
                                        parent.getRightItemEdge(gc));
                                gc.dispose();
                                maxImageWidth = rightEdge - imageX
                                        - (trim.width + trim.x);
                                if (!parent.single && closeRect.width > 0) {
                                    maxImageWidth -= closeRect.width
                                            + CustomizableTabFolderRenderer.INTERNAL_SPACING;
                                }
                            } else {
     ...
     * should be shown. If the parent (CustomizableTabFolder) was created with
     * SWT.CLOSE style, changing this value has no effect.
     * 
     * @param close
