...
Name: awips2-edex-hazards
Summary: awips2-edex-hazards Installation
...
unzip %{_baseline_workspace}/build.edex/edex/dist/edex-hazards.zip \
   -d %{_build_root}
...
/awips2/edex/data/utility/edex_static/base/HazardServices/ServiceBackup/configuration/*
/awips2/edex/lib/*
/awips2/edex/util_filelist.%{name}.txt
%defattr(755,awips,fxalpha,755)
/awips2/edex/scripts/*
/awips2/edex/data/utility/edex_static/base/HazardServices/ServiceBackup/scripts/*
