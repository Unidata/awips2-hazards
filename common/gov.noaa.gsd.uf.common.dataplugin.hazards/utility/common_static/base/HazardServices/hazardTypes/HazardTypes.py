...
#         endingExpirationDuration When a hazard (or portion of a hazard) is ending (CAN or EXP),
#                            the expiration time is set to currentTime + endingExpirationDuration.
#                            In milliseconds.
#         endingExpirationRounding When a hazard (or portion of a hazard) is ending (CAN or EXP),
#                            the expiration time is rounded up to the next multiple of this value.
#                            In milliseconds.
...
#                            not be performed.
#          inclusionFraction The minimum fraction a hazard polygon must cover a UGC area before
#                            the UGC can be included in the UGC list. Valid values range from
#                            0.0 to 1.0.
...
#
#  inclusionThresholdWarning If True, in the case that no UGCs meet inclusion thresholds, provide
#                            a warning indicating that UGC intersections will be recomputed
#                            without thresholds. False, do not display such warning. Defaults to
#                            False.
#
...
#                  hazardous Flag indicating whether or not the type is hazardous (generally a
#                            watch, warning, or advisory). Defaults to True if not specified.
...
#           elapseWhenIssued If True, the event will elapse when it is issued. Defaults to False.
#          elapseWhenExpired If True, the event will elapse when it has expired, ignoring end
...
HazardTypes = {
    ...
    'FF.W.Convective' : {'headline': 'FLASH FLOOD WARNING',
              '_override_lock_': OVERRIDE_LOCK,
              'combinableSegments': False,
              'allowAreaChange': False,
              'allowTimeChange': True,
    ...
    'FF.W.NonConvective' : {'headline': 'FLASH FLOOD WARNING',
              '_override_lock_': OVERRIDE_LOCK,
              'combinableSegments': False,
              'allowAreaChange': False,
              'allowTimeChange': True,
    ...
    'HY.S' : {'headline': 'FORECAST INFORMATION',  # No headline for this VTEC
              ...
              'requirePointId': True,
              'sessionAttributes': SESSION_ATTRS,
              'elapseWhenIssued': True,
              'elapseWhenExpired': False,
              'hazardous': False,
              },
