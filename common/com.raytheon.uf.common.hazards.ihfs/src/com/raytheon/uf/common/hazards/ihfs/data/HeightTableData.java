 ...
 * @version 1.0
 */
public class HeightTableData extends ObservedTableData {

    private static final long serialVersionUID = -4147096493698482728L;

    public HeightTableData() {
        super(HeightQueryTable.getInstance());
    }

    public HeightTableData(Object[] tableData) throws IhfsDatabaseException {
        super(HeightQueryTable.getInstance(), tableData);
    }
