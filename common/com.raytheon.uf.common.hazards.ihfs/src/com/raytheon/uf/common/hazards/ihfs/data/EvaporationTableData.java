 ...
 * @version 1.0
 */
public class EvaporationTableData extends ObservedTableData {

    private static final long serialVersionUID = -2174789374789894194L;

    public EvaporationTableData() {
        super(EvaporationQueryTable.getInstance());
    }

    public EvaporationTableData(Object[] tableData)
            throws IhfsDatabaseException {
        super(EvaporationQueryTable.getInstance(), tableData);
    }
