...
/**
 * 
 * Request object used to for deleting hazard event objects
 * 
 * <pre>
 * 
 * SOFTWARE HISTORY
 ...
 */
@DynamicSerialize
public class DeleteInteroperabilityRecordRequest extends HazardRequest {

    /**
     * The events to be deleted
     */
    @DynamicSerializeElement
    private List<HazardInteroperabilityRecord> events;

    /**
     * Creates a new DeleteInteroperabilityRecordRequest
     */
    public DeleteInteroperabilityRecordRequest() {
