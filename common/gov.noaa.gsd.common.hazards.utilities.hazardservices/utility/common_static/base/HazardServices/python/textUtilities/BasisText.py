'''
    ...
    Dec 21, 2015       14042    Robert.Blum            Fixed grammar issue with rain so far.
    ...
    def rainSoFar(self, identifier):
        ...
        if rainAmt == "rainKnown":
            ...
            if rainSoFarLowerBound == 0.0 and rainSoFarUpperBound == 0.0:
                ...
                result = " Between " + rainLower + " and " + rainUpper + inchText + ' of rain' + rainText
        return result
