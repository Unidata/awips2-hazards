...
'''
    A Python Wrapper of HydrographPrecip.java. This allows focal points the ability
...
class HydrographPrecip(Hydrograph, JUtil.JavaWrapperClass):

    def __init__(self, wrappedObject):
        super(HydrographPrecip, self).__init__(wrappedObject)

    def __str__(self):
        string = 'HydrographPrecip: ' + self.jobj.toString()
        return string

##########################################################
#
#    Getter methods from HydrographPrecip.java
#
