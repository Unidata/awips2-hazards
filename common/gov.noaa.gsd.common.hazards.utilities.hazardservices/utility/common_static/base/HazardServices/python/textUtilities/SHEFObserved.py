...
'''
    A Python Wrapper of SHEFObserved.java. This allows focal points the ability
...
class SHEFObserved(SHEFBase, JUtil.JavaWrapperClass):

    def __init__(self, wrappedObject):
        super(SHEFObserved, self).__init__(wrappedObject)

    def __str__(self):
        string = 'SHEFObserved: ' + self.jobj.toString()
        return string

##########################################################
#
#    Getter methods from SHEFObserved.java
#
