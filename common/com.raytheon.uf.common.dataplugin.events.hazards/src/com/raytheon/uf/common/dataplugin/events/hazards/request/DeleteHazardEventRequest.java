...
/**
 * 
 * Request object for deleting hazard events from the registry
 * 
 * <pre>
 * 
 * SOFTWARE HISTORY
 ...
 */
@DynamicSerialize
public class DeleteHazardEventRequest extends HazardRequest {

    /** List of events to be deleted from the registry */
     ...
     */
    public DeleteHazardEventRequest() {
     ...
     *            Practice mode flag
     */
    public DeleteHazardEventRequest(List<HazardEvent> events, boolean practice) {
        super(practice);
        this.events = events;
    }
