...
/**
 * Notification that is sent out through the SessionManager whenever the current
 * Settings filters are modified.
 * 
 * <pre>
 * 
 * SOFTWARE HISTORY
...
public class SettingsFiltersModified extends SettingsModified implements
        ISessionNotification {

    public SettingsFiltersModified(ISessionConfigurationManager manager) {
        super(manager);
    }
