 ...
 * buttons.
 * <p>
 * Note: This class was copied from RTS Data Delivery code; if it becomes
 * available via a common library at some point in the future, that version
 * should be used instead, and this class deleted.
 * 
 * <pre>
 * 
 * SOFTWARE HISTORY
...
public class ButtonImages {
    ...
    private void createButtonImages() {
        ...
        for (int i = 0; i < ButtonImage.values().length; i++) {
            if (ButtonImage.values()[i] == ButtonImage.Up
                    || ButtonImage.values()[i] == ButtonImage.Down) {
