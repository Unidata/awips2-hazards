...
/**
 * 
 * Handler class used for processing hazard event storage requests
 * 
 * <pre>
 * 
 * SOFTWARE HISTORY
 ...
 * @version 1.0
 */
public class StoreHazardEventHandler implements
        IRequestHandler<StoreHazardEventRequest> {

    @Override
    public HazardEventResponse handleRequest(StoreHazardEventRequest request)
            throws Exception {
