...
/**
 * Description: Handler used to process delete generic object requests.
 * 
 * <pre>
 * 
 * SOFTWARE HISTORY
 ...
 * @version 1.0
 */
public class DeleteGenericRegistryObjectHandler
        implements IRequestHandler<DeleteGenericRegistryObjectRequest> {

    @Override
    public GenericRegistryObjectResponse handleRequest(
            DeleteGenericRegistryObjectRequest request) throws Exception {
        return GenericRegistryObjectServicesSoapClient
                .getServices(request.isPractice())
                .deleteList(request.getGenericObjects());
    }
}
