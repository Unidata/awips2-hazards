...
import com.raytheon.uf.common.dataplugin.events.hazards.request.StoreHazardEventVtecRequest;
import com.raytheon.uf.common.serialization.comm.IRequestHandler;

/**
 * 
 * Handler for storing Hazard Event VTEC records
 * 
 * <pre>
 * 
 * SOFTWARE HISTORY
 ...
 * @version 1.0
 */
public class StoreHazardEventVtecHandler implements
        IRequestHandler<StoreHazardEventVtecRequest> {

    @SuppressWarnings("unchecked")
    @Override
    public Object handleRequest(StoreHazardEventVtecRequest request)
        ...
        for (Object vtecEntry : vtecList) {
            ...
            if (ids instanceof HashSet) {
                Set<String> ugcZones = (HashSet<String>) vtecMap.get(HazardConstants.UGC_ID);
        ...
        if (!vtecRecords.isEmpty()) {
            HazardVtecServicesSoapClient.getServices(practice).storeVtecList(
                    vtecRecords);
        }
        return response;
    }
