...
/**
 * 
 * Handler class used for hazard event update requests
 * 
 * <pre>
 * 
 * SOFTWARE HISTORY
 ...
 * @version 1.0
 */
public class UpdateHazardEventHandler implements
        IRequestHandler<UpdateHazardEventRequest> {

    @Override
    public HazardEventResponse handleRequest(UpdateHazardEventRequest request)
            throws Exception {
