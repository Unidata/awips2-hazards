...
/**
 * Description: Handler used to process delete all generic object requests.
 * 
 * <pre>
 * 
 * SOFTWARE HISTORY
 ...
 * @version 1.0
 */
public class DeleteAllGenericRegistryObjectsHandler
        implements IRequestHandler<DeleteAllGenericRegistryObjectsRequest> {

    @Override
    public GenericRegistryObjectResponse handleRequest(
            DeleteAllGenericRegistryObjectsRequest request) throws Exception {
        return GenericRegistryObjectServicesSoapClient
                .getServices(request.isPractice()).deleteAll();
    }
}
