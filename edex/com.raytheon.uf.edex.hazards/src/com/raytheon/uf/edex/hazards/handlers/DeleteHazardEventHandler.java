...
/**
 * 
 * Handler class used to process delete hazards requests
 * 
 * <pre>
 * 
 * SOFTWARE HISTORY
 ...
 * @version 1.0
 */
public class DeleteHazardEventHandler implements
        IRequestHandler<DeleteHazardEventRequest> {

    @Override
    public HazardEventResponse handleRequest(DeleteHazardEventRequest request)
            throws Exception {
        return HazardEventServicesSoapClient.getServices(request.isPractice())
                .deleteEventList(request.getEvents());
    }
}
