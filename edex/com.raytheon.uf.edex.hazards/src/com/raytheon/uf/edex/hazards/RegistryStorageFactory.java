...
import com.raytheon.uf.edex.hazards.registry.RegistryEventManager;

/**
 * Concrete implementation of {@link IHazardStorageFactory} to return a
 * {@link RegistryEventManager}
 * 
 * <pre>
 * 
 * SOFTWARE HISTORY
...
public class RegistryStorageFactory implements IHazardStorageFactory {
    ...
    public IHazardStorageManager getStorageManager() {
        return RegistryEventManager.getInstance();
    }
