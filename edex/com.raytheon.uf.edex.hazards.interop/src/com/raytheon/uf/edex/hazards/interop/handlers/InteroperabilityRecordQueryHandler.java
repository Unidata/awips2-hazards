...
/**
 * 
 * Handler class used to handle interoperability query requests
 * 
 * <pre>
 * 
 * SOFTWARE HISTORY
 ...
 * @version 1.0
 */
public class InteroperabilityRecordQueryHandler implements
        IRequestHandler<InteroperabilityRecordQueryRequest> {

    @Override
    public HazardInteroperabilityResponse handleRequest(
            InteroperabilityRecordQueryRequest request) throws Exception {
        return HazardEventInteropServicesSoapClient.getServices(
                request.isPractice()).retrieve(request);
    }
}
