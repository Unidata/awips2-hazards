 ...
 * @version 1.0
 */
public class DeleteInteroperabilityRecordHandler implements
        IRequestHandler<DeleteInteroperabilityRecordRequest> {

    @Override
    public HazardInteroperabilityResponse handleRequest(
            DeleteInteroperabilityRecordRequest request) throws Exception {
