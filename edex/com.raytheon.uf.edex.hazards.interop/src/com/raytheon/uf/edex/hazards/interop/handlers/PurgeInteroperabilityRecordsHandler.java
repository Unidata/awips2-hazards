...
/**
 * 
 * Handler used to process requests to purge the interoperability information
 * 
 * <pre>
 * 
 * SOFTWARE HISTORY
 ...
 * @version 1.0
 */
public class PurgeInteroperabilityRecordsHandler implements
        IRequestHandler<PurgeInteroperabilityRecordsRequest> {

    @Override
    public HazardInteroperabilityResponse handleRequest(
            PurgeInteroperabilityRecordsRequest request) throws Exception {
