...
/**
 * 
 * Handler used to process requests to purge the practice warning table
 * 
 * <pre>
 * 
 * SOFTWARE HISTORY
 ...
 * @version 1.0
 */
public class PurgePracticeWarningsHandler implements
        IRequestHandler<PurgePracticeWarningsRequest> {

    @Override
    public HazardInteroperabilityResponse handleRequest(
            PurgePracticeWarningsRequest request) throws Exception {
