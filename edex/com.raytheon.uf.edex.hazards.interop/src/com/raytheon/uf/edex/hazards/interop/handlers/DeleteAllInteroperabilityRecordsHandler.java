...
/**
 * 
 * Handler class used to process Delete All requests.
 * 
 * <pre>
 * 
 * SOFTWARE HISTORY
 ...
 * @version 1.0
 */
public class DeleteAllInteroperabilityRecordsHandler implements
        IRequestHandler<DeleteAllInteroperabilityRecordsRequest> {

    @Override
    public HazardInteroperabilityResponse handleRequest(
            DeleteAllInteroperabilityRecordsRequest request) throws Exception {
