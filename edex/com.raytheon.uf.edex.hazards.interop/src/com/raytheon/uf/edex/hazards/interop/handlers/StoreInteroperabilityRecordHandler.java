...
/**
 * 
 * Handler used to process requests to store intereoperability records
 * 
 * <pre>
 * 
 * SOFTWARE HISTORY
 ...
 * @version 1.0
 */
public class StoreInteroperabilityRecordHandler implements
        IRequestHandler<StoreInteroperabilityRecordRequest> {

    @Override
    public HazardInteroperabilityResponse handleRequest(
            StoreInteroperabilityRecordRequest request) throws Exception {
        ...
        HazardEventInteropServicesSoapClient.getServices(request.isPractice())
                .storeEventList(request.getEvents());
        return response;
    }
