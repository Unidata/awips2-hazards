...
/**
 * Posts to the registry for warnings from Warngen.
 * 
 * <pre>
 * 
 * SOFTWARE HISTORY
...
public class HazardWarningNotifier {

    /**
     * 
     */
    public HazardWarningNotifier() {
    }

    public void postToRegistry(PluginDataObject[] objects) {
        ActionRegistry.getInstance().postAction("warngen", objects);
    }
}
